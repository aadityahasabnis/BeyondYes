...
export const SITE_CONFIG = {
    ...
    author: {
        ...
        knowsAbout: ['Software Engineering', 'Web Development', 'TypeScript', 'JavaScript', 'React', 'Next.js', 'Node.js', 'System Design', 'Data Structures and Algorithms', 'Technical Writing'],
    },
