...
function DropdownMenuLabel({
    ...
    return <MenuPrimitive.GroupLabel data-slot="dropdown-menu-label" data-inset={inset} className={cn('px-2 py-1.5 text-xs text-muted-foreground data-inset:pl-7.5', className)} {...props} />;
}
